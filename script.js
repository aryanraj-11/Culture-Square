const shoes = [
    ...
    { id: 3, name: "Adidas Gazelle Shadow Brown", price: 6200, img: "adidas-gazelle-shadow-brown.jpg" }
    { id: 4, name: "Onitsuka Tiger Yellow", price: 5200, img: "onitsuka-tiger-yellow.jpg" }
];
